...
#define Vectors_height (2160)
#define Vectors_width (3840)
 ...
 * \param [in] instream_inImage The stream should be of size (param_dataSize * 4) bytes.
 * \param [out] outstream_outImage The stream should be of size (param_dataSize * 4) bytes.
 */
void Vectors(
	uint64_t param_dataSize,
	const uint32_t *instream_inImage,
	uint32_t *outstream_outImage);
...
typedef struct { 
	...
	const uint32_t *instream_inImage; /**<  [in] The stream should be of size (param_dataSize * 4) bytes. */
	uint32_t *outstream_outImage; /**<  [out] The stream should be of size (param_dataSize * 4) bytes. */
} Vectors_actions_t;
